...
type ChunkShape = ConstPow2Shape3u16<LENGTH_IN_VOXELS, LENGTH_IN_VOXELS, LENGTH_IN_VOXELS>;
...
pub fn pos_to_index(pos: U16Vec3) -> usize {
    ChunkShape::linearize(pos.into()) as usize
}

pub fn index_to_pos(index: usize) -> U16Vec3 {
    ChunkShape::delinearize(index as u16).into()
}
